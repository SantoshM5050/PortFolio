...
<div align="center">
  <img src="./public/santosh_profile.jpg" alt="Santosh Maurya" width="130" style="border-radius: 50%; border: 3px solid #00f0ff; box-shadow: 0 0 20px rgba(0,240,255,0.4);" />
...
```mermaid
graph TD
    A[Multiverse CyberOS Root] --> B[UEFI Boot Manager]
    B --> C1[Windows 12 Pro Mode]
    B --> C2[Quantum Neural Matrix]
    B --> C3[Stark Spatial HUD]
    B --> C4[Interstellar Bridge]
    B --> C5[Matrix Code Stream]
    B --> C6[Synthwave Outrun 80s]
    B --> C7[CyberOS Web Desktop]

    C7 --> D[Z-Index Window Manager]
    D --> E1[About App / User Profile]
    D --> E2[Interactive CLI Terminal]
    D --> E3[Projects Vault]
    D --> E4[Skill Matrix]
    D --> E5[Web Audio SFX & Radio]
```
